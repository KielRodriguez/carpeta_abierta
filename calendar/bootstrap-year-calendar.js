 ...
 (function($) {
	...
	Calendar.prototype = {
		...
		_initializeOptions: function(opt) {
			...
			this.options = {
				startYear: isNaN(parseInt(opt.startYear)) ? (new Date).getFullYear() : parseInt(opt.startYear),
		...
		_renderBody: function() {
			...
			for(var m = 0; m < 12; m++) {
				...
				titleCell.text(dates[this.options.language].months[m].toUpperCase());
				...
				// Se le agrega una fila mas para los meses que contengan menos de 5 filas
				var rowsNum = 1;
				while(currentDate <= lastDate || rowsNum === 6)
				{
